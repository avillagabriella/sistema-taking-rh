...
public class CandidatoServiceImpl implements CandidatoService {
    ...
    @Override
    public List<Candidato> findByAge(Integer age) {
        if (age != null)
    ...
    @Override
    public List<Candidato> findByAges(Integer age1, Integer age2) {
    ...
    @Override
    public List<Candidato> findByLanguage(String language) {
        if (language != null)
            return candidatoRepository.filterLanguages(language);
        else
            return null;
    }
}
